      ...
      <main className=" h-full  w-full flex justify-center py-32 px-24 bg-white dark:bg-black ">
        <div className="flex flex-col items-start gap-8">
          <div className="flex flex-col  gap-8 items-start">
            ...
            <h1 className=" text-start font-[instrument-serif-regular] leading-24 text-[6rem]  text-balance">
              The AI Agent for Modern Software Development
            </h1>
            <p className="text-[#a1a1a1] font-[instrument-serif-regular]  text-start text-xl w-160 text-balance">
